...
$procurement_pages = ['head/ppmp', 'head/pr'];
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                <a href="<?= base_url('head/dashboard') ?>"
                   class="dropdown-toggle <?= ($current_path === 'head/dashboard' || $current_path === 'head') ? 'active text-white fw-bold shadow-text' : '' ?>">
                    <div>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled <?= $is_procurement_page ? 'show' : '' ?>" id="procurement" data-bs-parent="#accordionExample" style="min-width: 20rem;">
                    <li>
                        <a href="<?= base_url('head/ppmp') ?>"
                           class="<?= $current_path === 'head/ppmp' ? 'active text-primary fw-bold' : '' ?>">
                            Project Procurement Management Plan
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('head/pr') ?>"
                           class="<?= $current_path === 'head/pr' ? 'active text-primary fw-bold' : '' ?>">
                            Purchase Request
                        </a>
                    </li>
                </ul>
            ...
            <li class="menu">
                <a href="<?= base_url('planning/tasks') ?>"
                   class="dropdown-toggle <?= $current_path === 'planning/tasks' ? 'active text-white fw-bold shadow-text' : '' ?>">
                    <div>
            ...
            <li class="menu">
                <a href="<?= base_url('planning/mr') ?>"
                   class="dropdown-toggle <?= $current_path === 'planning/mr' ? 'active text-white fw-bold shadow-text' : '' ?>">
                    <div>
