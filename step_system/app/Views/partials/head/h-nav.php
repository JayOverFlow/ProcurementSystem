...
$procurement_pages = ['/ppmp/create', 'head/pr', 'head/procurement'];
...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="<?= base_url('head/procurement') ?>"
                   class="dropdown-toggle <?= $current_path === 'head/procurement' ? 'active text-white fw-bold shadow-text' : '' ?>">
                    <div>
