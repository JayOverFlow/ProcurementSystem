<div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="<?= base_url('head/dashboard') ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="dropdown-menu submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                            <li class="">
                                <a href="<?= base_url('head/ppmp') ?>">Project Procurement Management Plan</a>
                            </li>

                            <li>
                                <a href="<?= base_url('head/pr') ?>">Purchase Request</a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu">
                        <a href="<?= base_url('head/tasks') ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="<?= base_url('head/mr') ?>" class="dropdown-toggle">
                            <div class="">
