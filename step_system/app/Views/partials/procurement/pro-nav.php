...
$procurement_pages = ['procurement/ppmp', 'procurement/pr', 'procurement/po', 'procurement/inventory'];
...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                <a href="<?= base_url('procurement/dashboard') ?>"
                   class="dropdown-toggle <?= ($current_path === 'procurement/dashboard' || $current_path === 'procurement') ? 'active text-white fw-bold shadow-text' : '' ?>">
                    <div>
                ...
                <li class="menu">
                <a href="<?= base_url('procurement/procurement') ?>"
                   class="dropdown-toggle <?= $current_path === 'procurement/procurement' ? 'active text-white fw-bold shadow-text' : '' ?>">
                    <div>
