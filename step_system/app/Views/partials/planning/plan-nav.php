<div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="<?= base_url('planning/dashboard') ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="dropdown-menu submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                            <li class="">
                                <a href="<?= base_url('planning/ppmp') ?>">Project Procurement Management Plan</a>
                            </li>
                            <li>
                                <a href="<?= base_url('planning/pr') ?>">Purchase Request</a>
                            </li>
                            <li>
                                <a href="<?= base_url('planning/app') ?>">Annual Procurement Plan</a>
                            </li>
                            <li>
                                <a href="<?= base_url('planning/inventory') ?>">Inventory</a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu">
                        <a href="<?= base_url('planning/tasks') ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="<?= base_url('planning/mr') ?>" class="dropdown-toggle">
                            <div class="">
