...
$procurement_pages = ['planning/ppmp', 'planning/pr', 'planning/app'];
...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                <a href="<?= base_url('planning/dashboard') ?>"
                   class="dropdown-toggle <?= ($current_path === 'planning/dashboard' || $current_path === 'planning') ? 'active text-white fw-bold shadow-text' : '' ?>">
                    <div>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled <?= $is_procurement_page ? 'show' : '' ?>" id="procurement" data-bs-parent="#accordionExample" style="min-width: 20rem;">
                    ...
                    <li>
                        <a href="<?= base_url('planning/pr') ?>"
                           class="<?= $current_path === 'planning/pr' ? 'active text-primary fw-bold' : '' ?>">
                            Purchase Request
                        </a>
                    </li>
                    <li>
