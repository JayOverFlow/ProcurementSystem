...
<?= $this->section('title') ?>
<title>TUP STEP | Procurement Office Purchase Request</title>
<?= $this->endSection() ?>
...
<form action="<?= base_url('head/pr/export-excel') ?>" method="post">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            ...
                                            <div class="invoice-address-client-fields">
                                                ...
                                                <div class="form-group row">
                                                    <label for="po-num-date" class="col-sm-3 col-form-label col-form-label-sm">P.R. No. Date</label>
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="num-date" name="pr_date">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label for="sat-no-date" class="col-sm-3 col-form-label col-form-label-sm">SAI. No. Date</label>
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="sai-no-date" name="sai_no_date">
                                                    </div>
                                                </div>
                                        ...
                                        <table class="table item-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="px-1"><input type="text" class="form-control form-control-sm" id="total-cost" name="items[0][total_cost]" readonly>
...
<script src="<?= base_url('assets/src/assets/js/apps/head-pr.js') ?>"></script>
<?= $this->endSection() ?>