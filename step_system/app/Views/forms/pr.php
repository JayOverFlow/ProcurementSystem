                                        ...
                                        <div class="col-xl-5 invoice-address-company">
                                            ...
                                            <div class="invoice-address-company-fields">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="pr-section" name="pr_section">
                                                    </div>
                                                </div>                                                     
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            ...
                                            <div class="invoice-address-client-fields">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="pr-no-date" name="pr_no_date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="pr-sai-no-date" name="pr_sai_no_date">
                                                    </div>
                                                </div>
                                ...
                                <div class="invoice-detail-items pt-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table item-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="px-1"><input type="text" class="form-control form-control-sm" id="qty" name="items[0][pr_items_quantity]">
                                                    <td class="px-1"><input type="text" class="form-control form-control-sm" id="unit" name="items[0][pr_items_unit]">
                                                    <td class="px-1"><input type="text" class="form-control form-control-sm" id="desc" name="items[0][pr_items_descrip]">
                                                    <td class="px-1"><input type="text" class="form-control form-control-sm" id="unit-cost" name="items[0][pr_items_cost]">
                                                    <td class="px-1"><input type="text" class="form-control form-control-sm" id="total-cost" name="items[0][pr_items_total_cost]">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            ...
                                            <div class="invoice-address-client-fields ms-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="pr-requested-by-designation" name="pr_requested_by_designation">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            ...
                                            <div class="invoice-address-client-fields ms-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="pr-approved-by-designation" name="pr_approved_by_designation">
                                                    </div>
                                                </div>
