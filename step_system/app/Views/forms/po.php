                                        ...
                                        <div class="col-xl-5 invoice-address-company">
                                            <div class="invoice-address-company-fields">
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-supplier" name="po_supplier" value="<?= old('po_supplier') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-address" name="po_address" value="<?= old('po_address') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-tele" name="po_tele" value="<?= old('po_tele') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-tin" name="po_tin" value="<?= old('po_tin') ?>">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            <div class="invoice-address-company-fields">
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-ponumber" name="po_ponumber" value="<?= old('po_ponumber') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="po-date" name="po_date" value="<?= old('po_date') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-mode" name="po_mode" value="<?= old('po_mode') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-tuptin" name="po_tuptin" value="<?= old('po_tuptin') ?>">
                                        ...
                                        <div class="col-xl-5 invoice-address-company">
                                            <div class="invoice-address-company-fields">
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-place-delivery" name="po_place_delivery" value="<?= old('po_place_delivery') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="po-date-delivery" name="po_date_delivery" value="<?= old('po_date_delivery') ?>">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            <div class="invoice-address-company-fields">
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-delivery-term" name="po_delivery_term" value="<?= old('po_delivery_term') ?>">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-payment-term" name="po_payment_term" value="<?= old('po_payment_term') ?>">
                                ...
                                <div class="invoice-detail-items pt-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table item-table">
                                            ...
                                            <tbody>
                                                <?php
                                                $items = old('items', [[]]); // Default to one empty row
                                                            ...
                                                            <div class="description-container">
                                                                ...
                                                                <?php if (!empty($item['specifications'])) : ?>
                                                                    <?php foreach ($item['specifications'] as $spec) : ?>
                                                                        <div class="input-group mb-1">
                                                                            <input type="text" class="form-control form-control-sm description-input-spec" name="items[<?= $index ?>][specifications][]" placeholder="Item specifications" value="<?= esc($spec) ?>">
                                            ...
                                            <div class="col-xl-8 invoice-address-company">
                                                <div class="invoice-address-company-fields">
                                                    <div class="form-group row mt-4">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text" class="form-control form-control-sm" id="po-description" name="po_description" value="<?= old('po_description') ?>">
                                                    ...
                                                    <div class="form-group row mt-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control form-control-sm" id="po-amount-in-words" name="po_amount_in_words" value="<?= old('po_amount_in_words') ?>">
                                            ...
                                            <div class="col-xl-4 invoice-address-client">
                                                <div class="invoice-address-company-fields">
                                                    <div class="form-group row mt-4">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control form-control-sm" id="po-total-amount" name="po_total_amount" value="<?= old('po_total_amount') ?>">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            ...
                                            <div class="invoice-address-client-fields">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="conforme-name-of-supplier" name="conforme_name_of_supplier" value="<?= old('conforme_name_of_supplier') ?>">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="conforme-date" name="conforme_date" value="<?= old('conforme_date') ?>">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            ...
                                            <div class="invoice-address-client-fields ms-3">
                                                ...
                                                <div class="form-group row mt-5">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="conforme-campus-director" name="conforme_campus_director" value="<?= old('conforme_campus_director') ?>">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            <div class="invoice-address-client-fields">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-fund-cluster" name="po_fund_cluster" value="<?= old('po_fund_cluster') ?>">
                                                ...
                                                <div class="form-group row mt-2">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-fund-available" name="po_fund_available" value="<?= old('po_fund_available') ?>">
                                                ...
                                                <div class="form-group row mt-2">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-accountant" name="po_accountant" value="<?= old('po_accountant') ?>">
                                        ...
                                        <div class="col-xl-5 invoice-address-client">
                                            <div class="invoice-address-client-fields">
                                                ...
                                                <div class="form-group row mt-4">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="po-orsburs" name="po_orsburs" value="<?= old('po_orsburs') ?>">
                                                ...
                                                <div class="form-group row mt-2">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="po-date-orsburs" name="po_date_orsburs" value="<?= old('po_date_orsburs') ?>">
