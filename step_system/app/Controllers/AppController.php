...
class AppController extends BaseController
{
    ...
    public function create()
    {
        ...
        try {
            ...
            $appModel->insert($appData);
            $appId = $appModel->getInsertID();
            ...
            if (!empty($itemData)) {
                $appItemModel->insertBatch($itemData);
            }
            ...
            if ($db->transStatus() === false) {
                return redirect()->back()->with('error', 'An error occurred while saving & submitting the Annual Procurement Plan.');
            }
            return redirect()->back()->with('success', 'Annual Procurement Plan has been saved & submitted.');
