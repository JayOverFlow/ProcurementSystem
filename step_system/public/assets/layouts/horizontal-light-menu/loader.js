window.addEventListener("load", function(){
        ...
        settings: {
            layout: {
                ...
                logo: {
                    ...
                    lightLogo: 'assets/images/logo2.svg'
                }
            }
        },
        reset: false
    ...
    if (equationThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', 'assets/images/logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', 'assets/images/logo2.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
