...
INSERT INTO `po_items_specs_tbl` VALUES (1,1,'kajbsfk'),(2,2,'onf'),(3,3,'asfh'),(4,4,'w');
...
INSERT INTO `po_items_tbl` VALUES (1,1,0,'b','kjb',2,23.00,NULL),(2,1,0,'kjb','kbkjbk',232,23.00,NULL),(3,2,0,'asda','asdasd',123,7.00,NULL),(4,2,0,'afkjb','asfb',8,9.00,NULL);
...
CREATE TABLE `po_tbl` (
  ...
  `po_ponumber` varchar(25) DEFAULT NULL,
  `po_date` varchar(25) DEFAULT NULL,
  ...
  `po_date_delivery` varchar(25) DEFAULT NULL,
  ...
  `po_date_orsburs` varchar(25) DEFAULT NULL,
  `po_amount` int DEFAULT NULL,
  `po_remarks` text,
  `saved_by_user_id_fk` int DEFAULT NULL,
  `po_description` text,
  `po_amount_in_words` varchar(100) DEFAULT NULL,
  `conforme_name_of_supplier` varchar(100) DEFAULT NULL,
  `conforme_date` varchar(25) DEFAULT NULL,
...
INSERT INTO `po_tbl` VALUES (1,NULL,NULL,'akjwfb','ab','bae','kajbf','kajbe','kabj','kjbk','jb','jhv ','hv','jhv','hvk',NULL,9,'aksfbj','kjb','kbk',98,NULL,42,'akjfb','lakbfaljfb','akjfb','j','jjhvjhv','ksfbjk',1000.00),(2,'Pending',NULL,'jb','kbgqkjgb','v','kj','bsdkgn','b','jv','jhv','jhvi','jhv','v','hv',NULL,0,'kjbkjb','aksbj','kjb',1029,NULL,42,'ajshfvk','kvk','kajbs','kjbkjb','kjb','kbkb',897.00);
...
INSERT INTO `pr_items_tbl` VALUES (1,1,0,0.00,0.00,'',''),(2,2,0,0.00,0.00,'',''),(3,3,0,0.00,0.00,'',''),(4,4,0,0.00,0.00,'',''),(8,8,2,0.00,0.00,'','');
...
INSERT INTO `pr_tbl` VALUES (1,NULL,'adsa','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,'csd','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,'','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,'','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,NULL,'kjg ','Pending',36,'2025-07-15','2025-06-10',3,'hb',11,'jg',34);
...
INSERT INTO `user_role_department_tbl` VALUES (25,2,NULL,26),(26,3,2,36),(27,1,NULL,2),(28,1,NULL,2),(29,71,NULL,3),(30,34,5,1),(31,47,NULL,1),(32,72,8,4),(33,4,NULL,35),(34,63,9,35),(35,52,34,1),(36,35,6,2),(37,36,NULL,4),(38,37,7,3),(39,42,12,16);
...
-- Dump completed on 2025-07-23 16:04:08
