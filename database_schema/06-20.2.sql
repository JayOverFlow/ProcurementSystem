...
--
-- Table structure for table `role_department_tbl`
--

DROP TABLE IF EXISTS `role_department_tbl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `role_department_tbl` (
  `role_id` int NOT NULL,
  `dep_id` int NOT NULL,
  PRIMARY KEY (`role_id`,`dep_id`),
  KEY `dep_id` (`dep_id`),
  CONSTRAINT `role_department_tbl_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `roles_tbl` (`role_id`),
  CONSTRAINT `role_department_tbl_ibfk_2` FOREIGN KEY (`dep_id`) REFERENCES `departments_tbl` (`dep_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `role_department_tbl`
--

LOCK TABLES `role_department_tbl` WRITE;
/*!40000 ALTER TABLE `role_department_tbl` DISABLE KEYS */;
/*!40000 ALTER TABLE `role_department_tbl` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `roles_tbl` VALUES (1,'Campus Director',35,1,3),(2,'Assistant Director for Academic Affairs ',36,1,4),(3,'Assistant Director for Administration and Finance ',37,1,4),(4,'Assistant Director for Research and Extension',38,1,4),(5,'Department Head - Basic Arts and Sciences Department',1,2,1),(6,'Department Head - Civil and Allied Department',2,2,1),(7,'Department Head - Mechanical and Allied Department',3,2,1),(8,'Department Head - Electrical and Allied Department',4,2,1),(9,'Planning Officer',30,1,2),(10,'Head - Human Resource Management',14,3,1),(11,'Head - Property and Supply',15,3,1),(12,'Head - Procurement',16,3,1),(13,'Head - Infrastructure Development',17,3,1),(14,'Head - Building and Grounds Maintenance',18,3,1),(15,'Head - Accounting',19,3,1),(16,'Head - Budgeting',20,3,1),(17,'Head - Collecting and Disbursing',21,3,1),(18,'Head - Medical Services',22,3,1),(19,'Head - Dental Services',23,3,1),(20,'Head - Records Management',24,3,1),(21,'Head - BAC Secretariat',25,3,1),(22,'Head - Campus Business Manager',26,3,1),(23,'Head - Office of Student Affairs',5,2,1),(24,'Head - Admission, Guidance and Counseling',6,2,1),(25,'Head - National Service Training Program',31,2,1),(29,'Head - Literacy Training Service',27,24,1),(30,'Head - Learning Resource Center',28,23,1),(31,'Head - Sports and Cultural Development',29,23,1),(32,'Head - Bachelor of Engineering Technology Major in Chemical Technology',2,6,1),(33,'Head - Bachelor of Science in Environmental Science',2,6,1),(34,'Head - Bachelor of Science in Civil Engineering',2,6,1),(35,'Head - Bachelor of Engineering Technology Major in Civil Technology',2,6,1),(36,'Head - Bachelor of Science in Electronics Engineering',4,8,1),(37,'Head - Bachelor of Engineering Technology Major in Electronics Technology',4,8,1),(38,'Head - Bachelor of Science in Information Technology',4,8,1),(39,'Head - Bachelor of Science in Electrical Engineering',4,8,1),(40,'Head - Bachelor of Engineering Technology Major in Electrical Technology',4,8,1),(41,'Head - Bachelor of Engineering Technology Major in Instrumentation and Controls',4,8,1),(42,'Head - Bachelor of Engineering Technology Major in Mechatronics Technology',4,8,1),(43,'Head - Bachelor of Science in Mechanical Engineering',3,7,1),(44,'Head - Bachelor of Engineering Technology Major in Heating, Ventilation and Air Conditioning, and Refrigeration Technology',3,7,1),(45,'Head - Bachelor of Engineering Technology Major in Dies and Moulds Technology',3,7,1),(46,'Head - Bachelor of Engineering Technology Major in Non-Destructive Testing Technology',3,7,1),(47,'Head - Bachelor of Engineering Technology Major in Electromechanical Technology',3,7,1),(48,'Head - Bachelor of Engineering Technology Major in Automotive Technology',3,7,1),(49,'Head - Bachelor of Engineering Technology Major in Mechanical Technology',3,7,1),(123,'Head - Research and Development Services',7,4,1),(124,'Head - Extension Services',8,4,1),(125,'Head - Innovation Technology Support Office',9,4,1),(126,'Head - Technology Licensing Office Coordinator',10,4,1),(127,'Head - Quality Assurance',11,1,1),(128,'Head - University Information Technology Center',12,1,1),(129,'Head - Gender and Development',13,1,1),(131,'Head - Project Management Committee',39,3,1),(146,'Head - Bachelor of Technical-Vocational Teacher Education',1,5,1),(148,'None',NULL,NULL,NULL),(149,'Assistant Director for Academic Affair',36,NULL,NULL);
...
-- Dump completed on 2025-06-20 11:48:37
