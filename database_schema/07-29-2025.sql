...
CREATE TABLE `ics_items_tbl` (
  ...
  `ics_qty` int DEFAULT NULL,
  `ics_unit` varchar(50) DEFAULT NULL,
  `ics_unit_cost` varchar(50) DEFAULT NULL,
  `ics_total_cost` varchar(50) DEFAULT NULL,
  `ics_descrip` text,
  `ics_invent_item_no` varchar(50) DEFAULT NULL,
  `ics_est_use_life` varchar(20) DEFAULT NULL,
  `ics_id_fk` int DEFAULT NULL,
  PRIMARY KEY (`ics_item_id`),
  KEY `fk_ics_items_ics_id_fk` (`ics_id_fk`),
  CONSTRAINT `fk_ics_items_ics_id_fk` FOREIGN KEY (`ics_id_fk`) REFERENCES `ics_tbl` (`invent_custo_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ics_tbl` (
  ...
  `ics_fund_cluster` varchar(45) DEFAULT NULL,
  `ics_po_no` varchar(45) DEFAULT NULL,
  `ics_par_no` varchar(45) DEFAULT NULL,
  `ics_code_no` varchar(45) DEFAULT NULL,
  `ics_received_from_user_fk` int DEFAULT NULL,
  `ics_received_from_date` varchar(45) DEFAULT NULL,
  `ics_received_by_user_fk` int DEFAULT NULL,
  `ics_received_by_date_fk` varchar(45) DEFAULT NULL,
  `saved_by_user_id_fk` int DEFAULT NULL,
  PRIMARY KEY (`invent_custo_id`),
  KEY `invent_custo_prop_ack_fk` (`invent_custo_prop_ack_fk`),
  KEY `invent_custo_received_from_fk` (`ics_received_by_date_fk`),
...
CREATE TABLE `par_items_tbl` (
  ...
  KEY `fk_par_items_par_id_fk` (`par_id_fk`),
  CONSTRAINT `fk_par_items_par_id_fk` FOREIGN KEY (`par_id_fk`) REFERENCES `par_tbl` (`prop_ack_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `par_items_tbl` VALUES (1,12,'2','asd','2','2025-07-01',1.72,2),(3,2,'12','asd','asd','2025-07-01',4.00,4),(4,-112,'2','kajsfb','23','2025-07-09',-99999999.99,3),(5,1,'asd','asd','asd','2025-07-31',2.00,5),(7,23,'23','sdv','q23','2025-07-21',123.00,6);
...
INSERT INTO `par_tbl` VALUES (2,'Draft',NULL,'asdasdkjn','lkn','lk','n',NULL,NULL,NULL,NULL,NULL,NULL,5,55,'2025-07-18',49,'2025-08-09'),(3,'Rejected',NULL,'asdnkjn','kjn','kjn','kjkjn',NULL,NULL,NULL,NULL,NULL,NULL,5,71,'2025-07-22',55,'2025-07-16'),(4,'Approved',NULL,'kasd','bkjb','kjb','kjbkj',NULL,NULL,NULL,NULL,NULL,NULL,5,71,'2025-07-28',5,'2025-07-28'),(5,'Rejected',NULL,'kasd','bkjb','kjb','kjbkj',NULL,NULL,NULL,NULL,NULL,NULL,5,71,'2025-07-28',42,'2025-07-28'),(6,'Approved',NULL,'asdasdkjn','asd','as','asf',NULL,NULL,NULL,NULL,NULL,NULL,5,71,'2025-07-17',46,'2025-07-16');
...
INSERT INTO `po_items_specs_tbl` VALUES (3,6,'sd'),(4,7,'asd'),(5,8,'12'),(6,9,'as'),(7,10,'asd');
...
INSERT INTO `po_items_tbl` VALUES (4,1,143,'','',0,0.00,0.00),(6,2,143,'2','asdasd',2,3.00,6.00),(7,3,0,'12','asd',123,100.00,12300.00),(8,4,12,'12','12',123,100.00,12300.00),(9,5,1,'2','asf',2,1.00,2.00),(10,6,1,'2','asf',2,1.00,2.00);
...
INSERT INTO `pr_items_tbl` VALUES (1,1,0,0.00,0.00,'',''),(2,2,0,0.00,0.00,'',''),(3,3,0,0.00,0.00,'',''),(4,4,0,0.00,0.00,'',''),(5,5,143,2.00,286.00,'2','ajfbs'),(6,6,143,2.00,286.00,'a','ajfbs'),(7,7,143,2.00,286.00,'2','ajfbs'),(8,8,143,2.00,286.00,'2','ajfbs'),(9,9,143,2.00,286.00,'2','ajfbs'),(10,10,143,2.00,286.00,'2','ajfbs'),(11,11,143,9.00,1287.00,'1','j'),(12,12,143,9.00,1287.00,'1','j'),(13,13,143,9.00,1287.00,'1','j'),(14,14,143,9.00,1287.00,'1','j'),(15,15,143,9.00,1287.00,'1','j');
...
INSERT INTO `pr_tbl` VALUES (1,NULL,'adsa','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,'csd','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,'','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,'','Pending',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,NULL,'bj','Draft',2,'2025-07-17','2025-07-09',72,'l',31,'k',71),(6,NULL,'p','Draft',26,'2025-07-23','2025-07-15',42,'f',62,'k',71),(7,NULL,'k','Draft',1,'2025-07-22','2025-07-10',42,'k',5,'k',71),(8,NULL,'alskn','Draft',26,'2025-07-10','2025-07-16',55,'kjb',49,'k',71),(9,NULL,'asd','Draft',2,'2025-07-17','2025-07-16',42,'akjfb',5,'k',71),(10,NULL,'jn','Pending',23,'2025-07-03','2025-07-03',41,'kjb',11,'k',71),(11,NULL,'k','Rejected',20,'2025-07-10','2025-07-16',55,'k',5,'k',7),(12,NULL,'k','Pending',26,'2025-07-10','2025-07-07',42,'k',72,'k',2),(13,NULL,'asd','Approved',20,'2025-07-23','2025-07-17',42,'k',5,'k',71),(14,NULL,'asd','Approved',2,'2025-07-23','',72,'k',55,'k',71),(15,NULL,'asd','Rejected',18,'2025-07-23','2025-07-23',72,'k',42,'k',71);
...
INSERT INTO `stepper_tbl` VALUES (1,2,'PPMP','','PPMP creation/submission is pending.','2025-07-24 00:06:10'),(2,2,'APP','','Awaiting PPMP approval.','2025-07-24 00:06:10'),(3,2,'PR','','Awaiting APP approval.','2025-07-24 00:06:10'),(4,2,'Bidding','','Awaiting PR approval.','2025-07-24 00:06:10'),(5,2,'PO','','Awaiting Bidding completion.','2025-07-24 00:06:10'),(6,2,'Delivery','','Awaiting PO approval.','2025-07-24 00:06:10'),(7,2,'PAR','','Awaiting Delivery completion.','2025-07-24 00:06:10'),(8,2,'ICS','','Awaiting PAR creation.','2025-07-24 00:06:10'),(9,35,'PPMP','','Phase PPMP is currently pending review.','2025-07-28 08:50:10'),(10,35,'APP','','Awaiting PPMP approval.','2025-07-28 08:50:10'),(11,35,'PR','','Awaiting APP approval.','2025-07-28 08:50:10'),(12,35,'Bidding','','Awaiting PR approval.','2025-07-28 08:50:10'),(13,35,'PO','','Awaiting Bidding completion.','2025-07-28 08:50:10'),(14,35,'Delivery','','Awaiting PO approval.','2025-07-28 08:50:10'),(15,35,'PAR','','Awaiting Delivery completion.','2025-07-28 08:50:10'),(16,35,'ICS','','Awaiting PAR creation.','2025-07-28 08:50:10'),(17,30,'PPMP','','PPMP creation/submission is pending.','2025-07-28 06:13:58'),(18,30,'APP','','Awaiting PPMP approval.','2025-07-28 06:13:58'),(19,30,'PR','','Awaiting APP approval.','2025-07-28 06:13:58'),(20,30,'Bidding','','Awaiting PR approval.','2025-07-28 06:13:58'),(21,30,'PO','','Awaiting Bidding completion.','2025-07-28 06:13:58'),(22,30,'Delivery','','Awaiting PO approval.','2025-07-28 06:13:58'),(23,30,'PAR','','Awaiting Delivery completion.','2025-07-28 06:13:58'),(24,30,'ICS','','Awaiting PAR creation.','2025-07-28 06:13:58'),(25,16,'PPMP','','PPMP creation/submission is pending.','2025-07-27 08:14:41'),(26,16,'APP','','Awaiting PPMP approval.','2025-07-27 08:14:41'),(27,16,'PR','','Awaiting APP approval.','2025-07-27 08:14:41'),(28,16,'Bidding','','Awaiting PR approval.','2025-07-27 08:14:41'),(29,16,'PO','','Awaiting Bidding completion.','2025-07-27 08:14:41'),(30,16,'Delivery','','Awaiting PO approval.','2025-07-27 08:14:41'),(31,16,'PAR','','Awaiting Delivery completion.','2025-07-27 08:14:41'),(32,16,'ICS','','Awaiting PAR creation.','2025-07-27 08:14:41'),(33,15,'PPMP','','PPMP creation/submission is pending.','2025-07-28 15:22:41'),(34,15,'APP','','Awaiting PPMP approval.','2025-07-28 15:22:41'),(35,15,'PR','','Awaiting APP approval.','2025-07-28 15:22:41'),(36,15,'Bidding','','Awaiting PR approval.','2025-07-28 15:22:41'),(37,15,'PO','','Awaiting Bidding completion.','2025-07-28 15:22:41'),(38,15,'Delivery','','Awaiting PO approval.','2025-07-28 15:22:41'),(39,15,'PAR','','Awaiting Delivery completion.','2025-07-28 15:22:41'),(40,15,'ICS','','Awaiting PAR creation.','2025-07-28 15:22:41'),(41,4,'PPMP','','Phase PPMP is currently pending review.','2025-07-24 22:02:06'),(42,4,'APP','','Awaiting PPMP approval.','2025-07-24 22:02:06'),(43,4,'PR','','Awaiting APP approval.','2025-07-24 22:02:06'),(44,4,'Bidding','','Awaiting PR approval.','2025-07-24 22:02:06'),(45,4,'PO','','Awaiting Bidding completion.','2025-07-24 22:02:06'),(46,4,'Delivery','','Awaiting PO approval.','2025-07-24 22:02:06'),(47,4,'PAR','','Awaiting Delivery completion.','2025-07-24 22:02:06'),(48,4,'ICS','','Awaiting PAR creation.','2025-07-24 22:02:06'),(49,1,'PPMP','','Phase PPMP is currently pending review.','2025-07-27 05:19:55'),(50,1,'APP','','Awaiting PPMP approval.','2025-07-27 05:19:55'),(51,1,'PR','','Awaiting APP approval.','2025-07-27 05:19:55'),(52,1,'Bidding','','Awaiting PR approval.','2025-07-27 05:19:55'),(53,1,'PO','','Awaiting Bidding completion.','2025-07-27 05:19:55'),(54,1,'Delivery','','Awaiting PO approval.','2025-07-27 05:19:55'),(55,1,'PAR','','Awaiting Delivery completion.','2025-07-27 05:19:55'),(56,1,'ICS','','Awaiting PAR creation.','2025-07-27 05:19:55'),(57,3,'PPMP','','Phase PPMP is currently pending review.','2025-07-28 05:11:00'),(58,3,'APP','','Awaiting PPMP approval.','2025-07-28 05:11:00'),(59,3,'PR','','Awaiting APP approval.','2025-07-28 05:11:00'),(60,3,'Bidding','','Awaiting PR approval.','2025-07-28 05:11:00'),(61,3,'PO','','Awaiting Bidding completion.','2025-07-28 05:11:00'),(62,3,'Delivery','','Awaiting PO approval.','2025-07-28 05:11:00'),(63,3,'PAR','','Awaiting Delivery completion.','2025-07-28 05:11:00'),(64,3,'ICS','','Awaiting PAR creation.','2025-07-28 05:11:00');
...
INSERT INTO `tasks_tbl` VALUES (85,5,NULL,'A Property Acknowledgement Receipt has been saved and is ready for submission.','2025-07-27 20:38:37',NULL,NULL,'Property Acknowledgement Receipt',NULL,NULL,2,NULL,0,'Pending'),(86,5,71,'A new Property Acknowledgement Receipt has been submitted for your review.','2025-07-28 12:01:49',NULL,NULL,'Property Acknowledgement Receipt',NULL,NULL,3,NULL,0,'Pending'),(87,5,71,'A new Property Acknowledgement Receipt has been submitted for your review.','2025-07-28 12:32:58',NULL,NULL,'Property Acknowledgement Receipt',NULL,NULL,4,NULL,0,'Pending'),(88,5,71,'A new Property Acknowledgement Receipt has been submitted for your review.','2025-07-28 13:05:37',NULL,NULL,'Property Acknowledgement Receipt',NULL,NULL,5,NULL,0,'Pending'),(89,7,1,'A new Purchase Request has been submitted for your review.','2025-07-28 14:05:16',NULL,NULL,'Purchase Request',11,NULL,NULL,NULL,0,'Pending'),(90,2,63,'A new Purchase Request has been submitted for your review.','2025-07-28 14:13:21',NULL,NULL,'Purchase Request',12,NULL,NULL,NULL,0,'Pending'),(91,71,5,'A new Purchase Request has been submitted for your review.','2025-07-28 14:17:12',NULL,NULL,'Purchase Request',13,NULL,NULL,NULL,1,'Pending'),(92,71,5,'A new Purchase Request has been submitted for your review.','2025-07-28 15:20:05',NULL,NULL,'Purchase Request',14,NULL,NULL,NULL,0,'Pending'),(93,42,1,'A new Purchase Order has been submitted for your review.','2025-07-28 15:33:47',NULL,NULL,'Purchase Order',NULL,4,NULL,NULL,0,'Pending'),(94,71,5,'A new Purchase Request has been submitted for your review.','2025-07-28 16:35:27',NULL,NULL,'Purchase Request',15,NULL,NULL,NULL,0,'Pending'),(95,42,1,'A new Purchase Order has been submitted for your review.','2025-07-28 16:49:42',NULL,NULL,'Purchase Order',NULL,5,NULL,NULL,0,'Pending'),(96,5,NULL,'A Purchase Order has been saved and is ready for submission.','2025-07-28 17:40:41',NULL,NULL,'Purchase Order',NULL,6,NULL,NULL,0,'Pending'),(97,5,71,'A new Property Acknowledgement Receipt has been submitted for your review.','2025-07-28 17:41:21',NULL,NULL,'Property Acknowledgement Receipt',NULL,NULL,6,NULL,0,'Pending');
...
INSERT INTO `user_role_department_tbl` VALUES (25,2,NULL,30),(26,3,NULL,1),(27,1,1,35),(28,1,NULL,2),(29,71,NULL,15),(30,34,5,1),(31,47,NULL,1),(32,72,36,4),(33,4,NULL,1),(34,63,9,30),(35,52,34,1),(36,35,6,2),(37,36,NULL,4),(38,37,7,3),(39,6,8,4),(41,7,NULL,35),(42,60,NULL,30),(43,5,11,15),(44,42,12,16);
...
-- Dump completed on 2025-07-29  8:13:00
