...
CREATE TABLE `tasks_tbl` (
  ...
  CONSTRAINT `tasks_tbl_ibfk_3` FOREIGN KEY (`ppmp_id_fk`) REFERENCES `ppmp_items_tbl` (`ppmp_item_id`),
...
INSERT INTO `user_role_department_tbl` VALUES (25,2,NULL,26),(26,3,2,36),(27,1,1,2),(28,1,NULL,2),(29,71,NULL,3),(30,34,NULL,1),(31,47,NULL,1),(32,72,5,1),(33,4,NULL,35),(34,6,3,35),(35,52,34,1);
...
-- Dump completed on 2025-07-15 15:57:59
