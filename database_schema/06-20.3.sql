...
INSERT INTO `roles_tbl` VALUES (1,'Campus Director',35,1),(2,'Assistant Director for Academic Affairs ',36,1),(3,'Assistant Director for Administration and Finance ',37,1),(4,'Assistant Director for Research and Extension',38,1),(5,'Department Head - Basic Arts and Sciences Department',1,2),(6,'Department Head - Civil and Allied Department',2,2),(7,'Department Head - Mechanical and Allied Department',3,2),(8,'Department Head - Electrical and Allied Department',4,2),(9,'Planning Officer',30,1),(10,'Head - Human Resource Management',14,3),(11,'Head - Property and Supply',15,3),(12,'Head - Procurement',16,3),(13,'Head - Infrastructure Development',17,3),(14,'Head - Building and Grounds Maintenance',18,3),(15,'Head - Accounting',19,3),(16,'Head - Budgeting',20,3),(17,'Head - Collecting and Disbursing',21,3),(18,'Head - Medical Services',22,3),(19,'Head - Dental Services',23,3),(20,'Head - Records Management',24,3),(21,'Head - BAC Secretariat',25,3),(22,'Head - Campus Business Manager',26,3),(23,'Head - Office of Student Affairs',5,2),(24,'Head - Admission, Guidance and Counseling',6,2),(25,'Head - National Service Training Program',31,2),(29,'Head - Literacy Training Service',27,24),(30,'Head - Learning Resource Center',28,23),(31,'Head - Sports and Cultural Development',29,23),(32,'Head - Bachelor of Engineering Technology Major in Chemical Technology',2,6),(33,'Head - Bachelor of Science in Environmental Science',2,6),(34,'Head - Bachelor of Science in Civil Engineering',2,6),(35,'Head - Bachelor of Engineering Technology Major in Civil Technology',2,6),(36,'Head - Bachelor of Science in Electronics Engineering',4,8),(37,'Head - Bachelor of Engineering Technology Major in Electronics Technology',4,8),(38,'Head - Bachelor of Science in Information Technology',4,8),(39,'Head - Bachelor of Science in Electrical Engineering',4,8),(40,'Head - Bachelor of Engineering Technology Major in Electrical Technology',4,8),(41,'Head - Bachelor of Engineering Technology Major in Instrumentation and Controls',4,8),(42,'Head - Bachelor of Engineering Technology Major in Mechatronics Technology',4,8),(43,'Head - Bachelor of Science in Mechanical Engineering',3,7),(44,'Head - Bachelor of Engineering Technology Major in Heating, Ventilation and Air Conditioning, and Refrigeration Technology',3,7),(45,'Head - Bachelor of Engineering Technology Major in Dies and Moulds Technology',3,7),(46,'Head - Bachelor of Engineering Technology Major in Non-Destructive Testing Technology',3,7),(47,'Head - Bachelor of Engineering Technology Major in Electromechanical Technology',3,7),(48,'Head - Bachelor of Engineering Technology Major in Automotive Technology',3,7),(49,'Head - Bachelor of Engineering Technology Major in Mechanical Technology',3,7),(123,'Head - Research and Development Services',7,4),(124,'Head - Extension Services',8,4),(125,'Head - Innovation Technology Support Office',9,4),(126,'Head - Technology Licensing Office Coordinator',10,4),(127,'Head - Quality Assurance',11,1),(128,'Head - University Information Technology Center',12,1),(129,'Head - Gender and Development',13,1),(131,'Head - Project Management Committee',39,3),(146,'Head - Bachelor of Technical-Vocational Teacher Education',1,5),(147,'Staff',NULL,NULL);
...
--
-- Dumping data for table `types_tbl`
--

LOCK TABLES `types_tbl` WRITE;
/*!40000 ALTER TABLE `types_tbl` DISABLE KEYS */;
INSERT INTO `types_tbl` VALUES (1,'Faculty'),(2,'Staff');
/*!40000 ALTER TABLE `types_tbl` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_role_department_tbl` (
  ...
  KEY `fk_type_fk` (`type_fk`),
  CONSTRAINT `fk_type_fk` FOREIGN KEY (`type_fk`) REFERENCES `types_tbl` (`type_id`),
...
INSERT INTO `user_role_department_tbl` VALUES (1,1,35,1),(2,132,35,1),(3,2,36,1),(4,133,36,1),(5,134,36,1),(6,3,37,1),(7,135,37,1),(8,4,38,1),(9,123,7,1),(10,124,8,1),(11,125,9,1),(11,125,10,1),(12,137,38,1),(13,137,37,1),(14,137,38,1),(15,23,5,1),(15,24,6,1),(16,140,6,1),(16,147,5,1),(17,138,5,1),(18,29,27,1),(19,139,27,1),(20,139,27,1),(21,139,27,1),(22,140,6,1),(23,140,6,1),(24,18,37,1),(25,19,37,1),(26,141,22,1),(27,147,35,1),(28,142,12,1),(29,143,12,1),(30,30,28,1),(31,144,28,1),(32,145,28,1),(33,31,29,1),(34,5,1,1),(35,6,2,1),(36,8,4,1),(37,7,3,1),(38,10,37,1),(39,15,19,1),(40,11,15,1),(41,16,20,1),(42,12,16,1),(43,13,17,1),(44,131,39,1),(45,14,18,1),(46,20,24,1),(46,21,25,1),(47,146,1,1),(48,25,31,1),(48,26,31,1),(49,27,3,1),(49,49,33,1),(50,28,34,1),(51,32,2,1),(51,33,2,1),(52,34,2,1),(52,35,2,1),(53,36,4,1),(53,37,4,1),(54,38,4,1),(55,39,4,1),(56,40,4,1),(57,41,4,1),(57,42,4,1),(58,43,3,1),(58,44,3,1),(59,45,3,1),(60,46,3,1),(61,47,3,1),(62,48,3,1),(63,9,30,1),(64,127,11,1);
...
INSERT INTO `users_tbl` (`user_id`, `user_firstname`, `user_middlename`, `user_lastname`, `user_email`, `user_password`, `user_type`, `user_suffix`, `user_tupid`) VALUES (1,'Rexmelle','F.','Decapia',NULL,NULL,NULL,NULL,NULL),(2,'Ruby','T.','Villanueva',NULL,NULL,NULL,NULL,NULL),(3,'Glenn','N.','Ortiz',NULL,NULL,NULL,NULL,NULL),(4,'Ivan Ray','G. ','Ancero',NULL,NULL,NULL,NULL,NULL),(5,'Krystel May','R.','Alvarado',NULL,NULL,NULL,NULL,NULL),(6,'Christian','C.','Calingasan',NULL,NULL,NULL,NULL,NULL),(7,'Corazon ','C.','Dela Rosa',NULL,NULL,NULL,NULL,NULL),(8,'Emmanuel','L.','Ferrer',NULL,NULL,NULL,NULL,NULL),(9,'Hector','M.','Tibo',NULL,NULL,NULL,NULL,NULL),(10,'Lieda','A.','Sobida',NULL,NULL,NULL,NULL,NULL),(11,'Jane','E.','Morgado',NULL,NULL,NULL,NULL,NULL),(12,'Ramil Leonardo','H.','Africa',NULL,NULL,NULL,NULL,NULL),(13,'Maureen','A.','Salve',NULL,NULL,NULL,NULL,NULL),(14,'Cindy','Q.','Maldecir',NULL,NULL,NULL,NULL,NULL),(15,'Mitchie','M.','Caurel',NULL,NULL,NULL,NULL,NULL),(16,'Christopher Mitchel','I.','Azuelo',NULL,NULL,NULL,NULL,NULL),(17,'Mary Rose Gabrielle','F.','Habla',NULL,NULL,NULL,NULL,NULL),(18,'Menerva Pesito',NULL,'Doctor',NULL,NULL,NULL,NULL,NULL),(19,'Grace','D.','Usana',NULL,NULL,NULL,NULL,NULL),(20,'Jenneth','L.','Yu',NULL,NULL,NULL,NULL,NULL),(21,'Roselle','L.','Honorio',NULL,NULL,NULL,NULL,NULL),(22,'Neizzel Joy','T.','Labro-Azuelo',NULL,NULL,NULL,NULL,NULL),(23,'Ma. Clowee Anne','M.','Sarmiento',NULL,NULL,NULL,NULL,NULL),(24,'Vivian','T.','Pangan',NULL,NULL,NULL,NULL,NULL),(25,'Normita','M.','Mata',NULL,NULL,NULL,NULL,NULL),(26,'Maria Carina','V.','Silvino',NULL,NULL,NULL,NULL,NULL),(27,'Jim','A.','Linda',NULL,NULL,NULL,NULL,NULL),(28,'Patrick Justin','L.','Ariado',NULL,NULL,NULL,NULL,NULL),(29,'Lizette','P.','Terania',NULL,NULL,NULL,NULL,NULL),(30,'Roy','J.','Garbin',NULL,NULL,NULL,NULL,NULL),(31,'Leilani','G.','Oledan',NULL,NULL,NULL,NULL,NULL),(32,'Anna Marie','A.','Dalaguit',NULL,NULL,NULL,NULL,NULL),(33,'Rogelio','C.','Mercurio',NULL,NULL,NULL,'III',NULL),(34,'Heherson','P.','Ramos',NULL,NULL,NULL,NULL,NULL),(35,'Norway','J.','Pangan',NULL,NULL,NULL,NULL,NULL),(36,'Raymund','M.','Lozada',NULL,NULL,NULL,NULL,NULL),(37,'June Raymond','L.','Mariano',NULL,NULL,NULL,NULL,NULL),(38,'Ma. Lizette','G.','Peña',NULL,NULL,NULL,NULL,NULL),(39,'Juliet','T.','Narez',NULL,NULL,NULL,NULL,NULL),(40,'Ronnie','A.','Ramos',NULL,NULL,NULL,NULL,NULL),(41,'Flordeliza','Y.','Valdez',NULL,NULL,NULL,NULL,NULL),(42,'Enrique','A.','Silvino',NULL,NULL,NULL,NULL,NULL),(43,'Roilene','C.','Pagatpat',NULL,NULL,NULL,NULL,NULL),(44,'Janiel Mico','D.','Panganiban',NULL,NULL,NULL,NULL,NULL),(45,'Sanjie Dutt','A.','Kumar',NULL,NULL,NULL,NULL,NULL),(46,'Al-Stephenson','B.','Lapastora',NULL,NULL,NULL,NULL,NULL),(47,'Cesar','S.','Mendoza',NULL,NULL,NULL,NULL,NULL),(48,'Reginald','B.','Cutanda',NULL,NULL,NULL,NULL,NULL),(49,'Clinton','P.','Icuspit',NULL,NULL,NULL,NULL,NULL),(50,'Maria Gena','C.','Cruz',NULL,NULL,NULL,NULL,NULL),(51,'Christopher','B.','Parmis',NULL,NULL,NULL,NULL,NULL),(52,'Maricel','S.','Ochoa',NULL,NULL,NULL,NULL,NULL),(53,'Marcelo','V.','Rivera',NULL,NULL,NULL,NULL,NULL),(54,'Julius Delfin','A.','Silang',NULL,NULL,NULL,NULL,NULL),(55,'Edwin','P.','Roldan',NULL,NULL,NULL,NULL,NULL),(56,'Renante','D.','Junto',NULL,NULL,NULL,NULL,NULL),(57,'Rica Jane','Y.','Kosca',NULL,NULL,NULL,NULL,NULL),(58,'Triztan','S.','Dela Cruz',NULL,NULL,NULL,NULL,NULL),(59,'Aldwin','C.','Aggabao',NULL,NULL,NULL,NULL,NULL),(60,'Nemalyn','P.','Decapia',NULL,NULL,NULL,NULL,NULL),(61,'Teodoro','M.','Nimuan',NULL,NULL,NULL,NULL,NULL),(62,'Eugene','C.','Singson',NULL,NULL,NULL,NULL,NULL),(63,'Jediah','P.','Puertollano',NULL,NULL,NULL,NULL,NULL),(64,'Angelica','F.','Olivar',NULL,NULL,NULL,NULL,NULL),(65,'Annaline','C.','Tanto',NULL,NULL,NULL,NULL,NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_user_roles_departments` AS select `u`.`user_id` AS `user_id`,`u`.`user_tupid` AS `tupt_id`,`u`.`user_firstname` AS `first_name`,`u`.`user_lastname` AS `last_name`,`u`.`user_email` AS `email`,`r`.`role_name` AS `role`,`d`.`dep_name` AS `department`,`t`.`type_name` AS `type` from ((((`user_role_department_tbl` `urd` join `users_tbl` `u` on((`urd`.`user_id` = `u`.`user_id`))) join `roles_tbl` `r` on((`urd`.`role_id` = `r`.`role_id`))) join `departments_tbl` `d` on((`urd`.`department_id` = `d`.`dep_id`))) left join `types_tbl` `t` on((`urd`.`type_fk` = `t`.`type_id`))) order by `u`.`user_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_users_for_role_assignment` AS select distinct `u`.`user_id` AS `user_id`,`u`.`user_tupid` AS `user_tupid`,`u`.`user_firstname` AS `user_firstname`,`u`.`user_lastname` AS `user_lastname`,`d`.`dep_name` AS `dep_name`,`urd`.`role_id` AS `role_id`,`r`.`role_name` AS `role_name` from (((`users_tbl` `u` join `user_role_department_tbl` `urd` on((`urd`.`user_id` = `u`.`user_id`))) join `departments_tbl` `d` on((`urd`.`department_id` = `d`.`dep_id`))) left join `roles_tbl` `r` on((`urd`.`role_id` = `r`.`role_id`))) order by `u`.`user_lastname` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-06-20 14:55:08
