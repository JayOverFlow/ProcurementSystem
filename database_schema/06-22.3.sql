...
INSERT INTO `user_role_department_tbl` VALUES (1,1,35),(3,2,36),(6,3,37),(8,4,38),(34,5,1),(35,6,2),(37,7,3),(36,8,4),(63,9,30),(38,10,37),(40,11,15),(42,12,16),(43,13,17),(45,14,18),(39,15,19),(41,16,20),(24,18,37),(25,19,37),(46,20,24),(46,21,25),(15,23,5),(15,24,6),(48,25,31),(48,26,31),(49,27,3),(50,28,34),(18,29,27),(30,30,28),(33,31,29),(51,32,2),(51,33,2),(52,34,2),(52,35,2),(53,36,4),(53,37,4),(54,38,4),(55,39,4),(56,40,4),(57,41,4),(57,42,4),(58,43,3),(58,44,3),(59,45,3),(60,46,3),(61,47,3),(62,48,3),(49,49,33),(9,123,7),(10,124,8),(11,125,9),(11,125,10),(64,127,11),(44,131,39),(2,132,35),(4,133,36),(5,134,36),(7,135,37),(12,137,38),(13,137,37),(14,137,38),(17,138,5),(19,139,27),(20,139,27),(21,139,27),(16,140,6),(22,140,6),(23,140,6),(26,141,22),(28,142,12),(29,143,12),(31,144,28),(32,145,28),(47,146,1),(16,147,5),(27,147,35);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_users_for_role_assignment` AS select distinct `u`.`user_id` AS `user_id`,`u`.`user_tupid` AS `user_tupid`,`u`.`user_firstname` AS `user_firstname`,`u`.`user_lastname` AS `user_lastname`,`d`.`dep_name` AS `dep_name`,`d`.`dep_id` AS `department_id`,`urd`.`role_id` AS `role_id`,`r`.`role_name` AS `role_name` from (((`users_tbl` `u` join `user_role_department_tbl` `urd` on((`urd`.`user_id` = `u`.`user_id`))) join `departments_tbl` `d` on((`urd`.`department_id` = `d`.`dep_id`))) left join `roles_tbl` `r` on((`urd`.`role_id` = `r`.`role_id`))) order by `u`.`user_lastname` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-06-22 13:43:06
